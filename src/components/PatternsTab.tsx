      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="glass-panel rounded-2xl p-5 flex flex-col">
          ...
          {patterns.repeatedWords.length === 0 ? (
            ...
            <div className="space-y-3 grow overflow-y-auto max-h-[280px] pr-1">
        ...
        <div className="glass-panel rounded-2xl p-5 flex flex-col">
          ...
          {patterns.transitionWords.length === 0 ? (
            ...
            <div className="space-y-2.5 grow overflow-y-auto max-h-[280px] pr-1">
              ...
              {patterns.duplicateSentences.slice(0, 5).map((dup, idx) => (
                <div key={idx} className="p-3 rounded-xl bg-amber-500/5 border border-amber-500/10">
                  <div className="flex justify-between items-start mb-1 text-xs">
                    ...
                    <span className="ml-2 shrink-0 text-[10px] font-bold bg-amber-500/10 text-amber-400 px-2 py-0.5 rounded">
                      {dup.count}x Matches
                    </span>
                  </div>
                  <div className="text-[10px] text-slate-500">
